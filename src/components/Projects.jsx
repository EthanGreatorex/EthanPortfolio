...
const project_data = [
  {
    ...
    technologies: [{ icon: FaReact }, { icon: FaNodeJs }, { icon: SiExpress }, { icon: SiPrisma }, { icon: SiPostgresql }],
    description: 'A full stack Twitter clone built with React, Express & Prisma ORM.',
    date: '2026',
  },
  {
    title: 'PaperSync',
    ...
    description: 'An iOS app that uses AI to scan physical documents for dates and events, and adds them to Apple Calendar.',
    date: '2026',
  },
  {
    title: 'Chatty',
    ...
    technologies: [{ icon: FaReact }],
    description: 'A live chatting website! Create an account, and message other users.',
    date: '2025',
  },
  {
    title: 'SmartRoute',
    ...
    description: 'EMIOT Challenge award winning design prototype for easier, smarter and more eco route planning.',
    date: '2025',
  },
  {
    title: "WheresWally",
    ...
    description: "A fun where's Wally game with leaderboards! Built with React, Express & MongoDB.",
    date: '2025',
  },
  {
    title: 'Cosmo AI',
    ...
    technologies: [{ icon: FaPython }, { icon: FaCss3 }, { icon: FaHtml5 }, { icon: FaFlask }],
  ...
  },
  {
    ...
    technologies: [{ icon: FaCss3 }, { icon: FaHtml5 }, { icon: FaFlask }, { icon: FaPython }],
    description: 'An app that allows users to view articles in a simple format through web scraping. Originally started as a Python Tkinter app.',
    date: '2024',
  },
  {
  ...
  },
  {
    ...
    description: 'A game built using Python and Pygame. Players must avoid the asteroids which get faster over time.',
    date: '2022',
  },
];
    ...
    >
      ...
      >
        <div className="project-card-image-wrap">
          ...
          <span className="project-card-arrow" aria-hidden>↗</span>
        </div>
    ...
    >
      ...
      <div className="projects-grid">
        {project_data.map((project, index) => (
          <TiltCard key={project.title + project.date} project={project} index={index} />
        ))}
      </div>
    </MotionSection>
  );
